      ...
      <header className="fixed w-full  top-0 md:z-10   ">
        ...
        <nav className="hidden md:flex justify-end font-helvetica px-5 md:px-10 pt-10 sticky top-0">
          <ul className="flex gap-8 text-xl">
            ...
            <motion.li className="cursor-pointer w-fit relative overflow-hidden">
        ...
        >
          <AnimatePresence mode="wait">
            <motion.nav
              ...
              animate={isHover ? "open" : "hidden"}
              onMouseLeave={() => setIsHover(false)}
              className=" max-h-auto origin-top p-10 bg-white rounded-xl"
            >
              <AnimatePresence mode="wait">
                {isHover && (
                  <>
                    {navsItem.map((item) => (
                      <div className="mb-5">
                        <motion.ul className="flex overflow-hidden w-full justify-between h-[3.5vw] 3xl:h-16 ">
                          <motion.li
                            onHoverStart={() => {
