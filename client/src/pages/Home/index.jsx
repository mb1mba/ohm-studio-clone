      ...
      <AnimatePresence>
        <div className="bg-[#f2eef0]">
          ...
          >
              ...
              <div className=" py-[5.65vw]  mx-[6.75vw] md:mx-[2.75vw]  grid gap-[13vw] md:gap-[8vw] md:grid-cols-3/10">
                <div className="flex flex-col gap-4 md:gap-[1vw]">
                  <p className="font-helvetica text-xl md:text-[1.5vw] 3xl:text-[1.6rem] leading-[1.25] font-semibold">
                    ...
                    <br />
                    Her line like her conception is clear simplicity,
                    triviality.
                  </p>
                  <Link
            ...
            <section>
              <div className="py-[5.65vw] mx-[6.75vw] md:mx-[2.75vw]  grid  gap-[14vw] md:gap-0 md:grid-cols-3/10 relative">
            ...
            <section>
              <div className="py-[5.65vw]  mx-[6.75vw] md:mx-[2.75vw]  grid gap-[14vw] md:gap-0 md:grid-cols-10/3 relative">
                <CardDiv
                  text="PION - Orange"
                  price="600"
                  align="between"
